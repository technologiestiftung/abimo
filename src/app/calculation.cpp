...
void Calculation::writeResultRecord(AbimoInputRecord& record, DbaseWriter& writer)
{
    ...
    writer.setRecordField("R", m_totalRunoff_R);
    writer.setRecordField("ROW", m_surfaceRunoff_ROW);
    writer.setRecordField("RI", m_infiltration_RI);
    ...
    writer.setRecordField("VERDUNSTUN", m_evaporation_VERDUNSTUN);
}
